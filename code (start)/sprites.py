...
class CollidableSprite(Sprite):
    def __init__(self, pos, surf, groups):
        ...
        self.hit_box = self.rect.inflate(0, -self.rect.height * 0.6)  # Adjust hit box to avoid collision with the top part of the sprite
...
class MonsterSprite(pygame.sprite.Sprite):
    ...
    def animate(self, dt):
        ...
        self.adjust_frame_index = int(self.frame_index % len(self.frames[self.state]))
        self.image = self.frames[self.state][self.adjust_frame_index]
...
class MonsterOutlineSprite(pygame.sprite.Sprite):
    ...
    def update(self, _):
        self.image = self.frames[self.monster_sprite.state][self.monster_sprite.adjust_frame_index]
        if not self.monster_sprite.groups():
            self.kill()
