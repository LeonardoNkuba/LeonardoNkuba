...
class MonsterIndex:
    ...
    def display_main(self, dt):
        ...
        for index, (stat, value) in enumerate(monster_stats.items()):
            ...
            text_rec = text_surf.get_frect(topleft = icon_rect.topleft + vector(30, -10))
            self.display_surface.blit(text_surf, text_rec)
            #bar
            bar_rect = pygame.FRect((text_rec.left, text_rec.bottom + 2), (single_stat_rect.width -(text_rec.left - single_stat_rect.left), 4))
