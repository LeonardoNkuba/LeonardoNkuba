...
class Battle:
    def __init__(self, player_monsters, opponent_monsters, monster_frames, bg_surf, fonts):
        ...
        #timers
        self.timers = {
            'opponent delay': Timer(600, func = self.opponent_sprites)
        }
        ...
        if self.selection_mode and self.current_monster:
            ...
            if keys[pygame.K_SPACE]:
                ...
                if self.selection_mode == 'target':
                    ...
                    monster_sprites = sprites[list(sprites.keys())[self.indexes['target']]]

                    if self.selected_attack:
                        self.current_monster.activate_attack(monster_sprites, self.selected_attack)
    ...
    def apply_attack(self, target_sprite, attack, amount):
        ...
        if attack_element == 'fire' and target_element == 'plant' or\
            attack_element == 'plant' and target_element == 'water' or\
            attack_element == 'water' and target_element == 'fire':
            amount *= 2

        #halve attacks
        if attack_element == 'fire' and target_element == 'water' or\
            attack_element == 'plant' and target_element == 'fire' or\
            attack_element == 'water' and target_element == 'plant':
            amount *= 0.5
